...
function ws_3721up_admin_menu_constructor(){
	$page = add_options_page('WP-3721UP Setting Page',
								'WP-3721UP',
								'manage_options'  ,
								'ws_3721up_plugin_id'      ,
...
function ws_3721up_admin_init() {
	wp_register_script('ws_3721up_main_js', WP_PLUGIN_URL . '/wp-3721up/javascripts/main.js',array('jquery') );
...
function add_wp_3721up_tinymce_plugin($plugin_array) {
   $plugin_array['wp_3721up'] = WP_PLUGIN_URL . '/wp-3721up/javascripts/tinymce.js';
   return $plugin_array;
}
