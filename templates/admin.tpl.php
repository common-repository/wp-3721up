...
//这仅是一个范例,勿抄袭!请自行到官方网站获取正确的API代码并贴入左侧文本框中
            ...
            <div id="plugin_info">
                 ...
                 <a href="http://www.waisir.com/3721up" target="_blank">关于插件的更多信息</a>
                 <a href="http://www.waisir.com/wp_donate" target="_blank" style=""><img id="ws_3721up_donate" src="../wp-content/plugins/wp-3721up/styles/images/donate.gif"/></a>
            </div>
        </div>
